    ...
    <div className="w-full">
      ...
      <div className="tabs w-full rounded-md overflow-hidden border border-base-300">
        {["today", "week", "custom"].map((key) => (
          <button
            key={key}
            className={`tab tab-bordered flex-1 text-sm font-medium ${
              tab === key
      ...
      <div className="mt-6 space-y-6">
        ...
        {tab === "week" && (
          <div className="flex h-40 items-center justify-center rounded-md border border-dashed border-base-300">
            <p className="text-sm text-gray-500">
              Weekly plan view will appear here
            </p>
          </div>
        )}
        ...
        {tab === "custom" && (
          <div className="flex h-40 items-center justify-center rounded-md border border-dashed border-base-300">
            <p className="text-sm text-gray-500">
              Custom plan builder will appear here
            </p>
          </div>
        )}
      </div>
