      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
        <div className="flex flex-col justify-center space-y-4">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-wide sm:text-4xl xl:text-5xl text-[#ec9f2b] leading-[60px] " style={{fontFamily:'poppins'}}>
              Your Health Is Our Top <br></br> Priority
            </h1>
            <p className="max-w-[600px] text-gray-600 md:text-xl" style={{fontFamily:'poppins'}}>
