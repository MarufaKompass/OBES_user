     ...
     <div className="bg-white text-gray-800">
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          />
          <div>
            <h2 className="text-3xl font-bold mb-4 text-[#FE9A00]">Who We Are</h2>
      ...
      <section className="bg-gray-100 py-12 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-2xl font-semibold mb-2 text-[#FE9A00]">Our Vision</h3>
            <p>
              To be a trusted global partner delivering high-impact technology solutions that drive meaningful business growth.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-2xl font-semibold mb-2 text-[#FE9A00]">Our Mission</h3>
            <p>
